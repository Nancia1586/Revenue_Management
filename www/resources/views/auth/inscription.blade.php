            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="/util/action_inscription" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="login" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                </div>  <div class="form-group">
                  <label>Date de naissance</label>

                  <input type="date" name="date" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                </div>
                <div class="form-group">
                  <label>Genre</label>
