...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="/stat/voir_commission" method="get">
                <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive pt-3">
                    <table class="table table-striped table-bordered" border="1" style="font-size:20px">
                        ...
                        <tr>
                            @php
                            $row->commission=Commission::getMontantApresCommission($row->totalvente,$row->moisvente, $row->anneevente);
                            @endphp
                            <td>{{ $row->nommoisvente }}</td>
                            <td>{{ Util::format($row->totalvente) . ' ' }}Ar</td>
                            <td>{{ Util::format(Commission::getMontantApresCommission($row->totalvente,$row->moisvente, $row->anneevente)) . ' ' }}Ar
                            </td>
