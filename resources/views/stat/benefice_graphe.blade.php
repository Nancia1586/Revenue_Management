        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href='benefice'> <button class="btn btn-warning">Retour</button></a>
                    ...
                    <div id="lineChasrt"></div>
<?php $test='dina'; ?>
                    <script>
                        document.addEventListener("DOMContentLoaded", () => {
                            new ApexCharts(document.querySelector("#lineChasrt"), {
                                series:
                                @if($test=='dina')
                                [  {
                                    name: "Desktops",
                                    data: [12342, 42534, 34543, 543412
                                    ]
                                },{
                                    name: "Autre",
                                    data: [122, 42534, 34543, 543412
                                    ]
                                }
                                ]
                                @else
                                 [12342, 42534, 34543, 543412
                                    ]
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", () => {
                            new ApexCharts(document.querySelector("#pieChart"), {
                                ...
                                labels: ['Team cA', 'Team B', 'Team C', 'Team D', 'Team E', 'Team Easd']
                            }).render();
                        });
                    </script>
                    <!-- End Pie Chart -->
